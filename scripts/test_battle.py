...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, choices={'attention_mfq', 'causal_mfq','ac', 'mfac', 'mfq', 'il', 'me_mfq'}, help='choose an algorithm from the preset', required=True)
    parser.add_argument('--oppo', type=str, choices={'attention_mfq', 'causal_mfq', 'ac', 'mfac', 'mfq', 'il', 'me_mfq'}, help='indicate the opponent model')
    parser.add_argument('--algo_dir', type=str, help='the path of the algorithm')
    parser.add_argument('--oppo_dir', type=str, help='the path of the opponent model')
